...
export class SendCommentReplyService {
    ...
    try {
      switch (reply.platform.toLowerCase()) {
        ...
        case 'linkedin':
          ...
          break;
        case 'youtube':
          await this.replyYoutube(reply.externalCommentId, params.message, account);
          break;
        default:
  ...
  private async replyYoutube(commentId: string, message: string, account: SocialAccounts) {
